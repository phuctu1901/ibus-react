...
export default class DetailRoute extends React.Component {
  ...
  buyticket = ticket_id => {
    ...
    this.props.navigation.navigate("MomoPayment", {route: route, station_id: this.state.station_id });
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        {!this.state.stations.length && <CenterMessage message="No locations" />}
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity onPress={()=>this.buyticket(this.state.route.ticket_id)}>
