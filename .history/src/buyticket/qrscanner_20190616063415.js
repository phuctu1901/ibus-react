...
export default class StationScanner extends Component {
  constructor() {
...
async getRouteByStationId(station_id){
    ...
    fetch('http://192.168.1.100:8000/api/route/getroute', {
      ...
      .then((responseJson) => {
        ...
        console.log(routes);
        this.props.navigation.navigate("ListRoute", { station_id: station_id, routes: routes });
    ...
    if (!this.state.opneScanner) {
      return (
        <View style={styles.container}>
            <Text style={styles.simpleText}>Đưa camera về phía mã QR của trạm và bật máy quét</Text>
