...
export default class DetailRoute extends React.Component {
  ...
  static navigationOptions = {
      title: "Chi tiết tuyến: " + this.props.navigation.state.params.route.title,
      headerTitleStyle: {
        fontSize: 20,
        fontWeight: "400"
      }
  ...
  async componentDidMount() {
    ...
    fetch('http://192.168.1.100:8000/api/route/getroutedetail', {
        ...
        headers: {
              ...
              body: JSON.stringify({
                route_id: "d01ee946-8729-11e9-8ba8-58fb84d377cd",
              }),
    })
      ...
      .then((responseJson) => {
        ...
        // });
        this.state.stations = this.state.stations.concat(stations);
        this.setState({
          isLoading: false,
